...
home_body = """  <header class="hero">
    ...
    <div class="wrap hero__inner">
      <p class="brand"><span>NeurIPS 2026 Workshop · AABA4ET</span>2nd Workshop on Agentic AI Benchmarks and Applications for Enterprise Tasks</p>
      <h1 class="hero__tagline">Where Agentic AI meets the real world of work</h1>
      <p class="hero__lede">
