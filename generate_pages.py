...
{social_icons("https://www.karyafar.com/", "https://www.linkedin.com/in/karyafar", "https://scholar.google.com/citations?user=whu7X_kAAAAJ&hl=en")}
      ...
      <article class="person-full speaker">
        ...
        <div class="person-copy">
          ...
          <p><strong>Dr. Mehdi Bahrami</strong> is a <strong>Senior Research Manager at Fujitsu Research of America</strong>, where he leads research on <strong>Agentic AI, LLM-based agents, and AI for software engineering</strong>. His recent work includes <strong>Kozuchi Agent</strong>, an open-weight agent framework for autonomous software engineering and repair. His broader research interests include generative AI, LLMs, and applied machine learning.</p>
          <p>Dr. Bahrami has over 15 years of experience in software engineering and industrial AI research, with <strong>30+ technical publications and 34+ granted U.S. patents</strong>. He is an <strong>ACM Distinguished Speaker and Senior Member of ACM and IEEE</strong>, and a recipient of the <strong>2024 IEEE Outstanding Engineer Award</strong> for pioneering contributions to generative AI and API automation. His work has also been recognized with multiple industry awards and featured by leading technology media, including <strong>MIT Technology Review</strong>.</p>
